...
export const PHASE_1_EXECUTIVE_QUESTIONS: ExecutiveQuestion[] = [
  ...
  },
  {
    ...
    answer_surface: "dashboard",
    answer_confidence: 88,
    summary_only_routes: ["/migration/workspace-architecture", "/migration/proof", "/migration/planning", "/migration/approval", "/migration/cutover"],
  },
  {
    question_id: "EQ-015",
  ...
  {
    question_id: "EQ-016",
    canonical_question: "Who are my contacts and how do I reach them?",
    owner_department: "Contacts",
    primary_route: "/studio/contacts",
    supporting_engines: ["ENG-CONTACT-001", "CONTACT-V3-016"],
    supporting_workspaces: [],
    answer_surface: "dashboard",
    answer_confidence: 85,
    summary_only_routes: [],
  ...
  {
    question_id: "EQ-017",
    canonical_question: "How do trusted identities enter the platform?",
    owner_department: "Identity Acquisition",
    primary_route: "/studio/ingestion",
    supporting_engines: ["CONTACT-V3-100"],
    supporting_workspaces: [],
    answer_surface: "dashboard",
    answer_confidence: 85,
    summary_only_routes: [],
  ...
  {
    question_id: "EQ-018",
    canonical_question: "Who can do the work, and how is human capacity coordinated?",
    owner_department: "Volunteer Operations",
    primary_route: "/studio/volunteer",
    supporting_engines: ["VOP-001"],
    supporting_workspaces: [],
    answer_surface: "dashboard",
    answer_confidence: 70,
    summary_only_routes: [],
  },
];
...
export const QUESTION_RELATED_IDS: Record<string, string[]> = {
  ...
  "EQ-006": ["EQ-001", "EQ-007", "EQ-004", "EQ-013", "EQ-002", "EQ-010", "EQ-016"],
  ...
  "EQ-016": ["EQ-006", "EQ-001", "EQ-013", "EQ-007", "EQ-004", "EQ-010", "EQ-011", "EQ-017"],
  "EQ-017": ["EQ-016", "EQ-001", "EQ-002", "EQ-007", "EQ-004", "EQ-010", "EQ-018"],
  "EQ-018": ["EQ-016", "EQ-017", "EQ-001", "EQ-007", "EQ-004", "EQ-010"],
