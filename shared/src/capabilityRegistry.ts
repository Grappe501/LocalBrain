...
const CAPABILITY_EXECUTIVE_OUTCOMES: Record<string, string> = {
  ...
  "CAP-CONTACT-001":
    "Maintain trustworthy people records with outreach context and relationship history.",
  "CAP-UCIE-100":
    "Acquire trusted identities from CSV, OCR, and manual intake with staged resolution before commit.",
  "CAP-VOP-001":
    "Turn trusted contacts into coordinated human action — claimable work, matching, and supervisor oversight.",
  "CAP-REL-001":
...
export const CAPABILITY_REGISTRY: CapabilityEntry[] = [
  ...
  cap({
    capability_id: "CAP-CONTACT-001",
    title: "Contact Management",
    description: "Trustworthy people records — CRUD, CSV, timeline, relationship contexts",
    executive_question_ids: ["EQ-016"],
    primary_route: "/studio/contacts",
    secondary_routes: [],
    prerequisites: [],
    next_recommended_steps: ["CAP-REL-001"],
    departments: ["Contacts"],
    workflows: [],
    keywords: ["contacts", "crm", "people", "outreach", "context"],
    search_terms: ["manage contacts", "contact records", "contact management"],
    authority_level: "authoritative",
    completion_status: "production",
    maturity: {
      completion_percent: 94,
      health: "healthy",
      last_verified_slice: "CONTACT-V3-021",
      dependency_capability_ids: ["CAP-UCIE-100"],
    },
    slice_id: "CONTACT-V3-021",
    nav_placement: "department",
    nav_order: 4,
  }),
  cap({
    capability_id: "CAP-UCIE-100",
    title: "Identity Acquisition (UCIE)",
    description: "Stage, resolve, and commit trusted identities from CSV, OCR, and manual intake",
    executive_question_ids: ["EQ-017"],
    primary_route: "/studio/ingestion",
    secondary_routes: [],
    prerequisites: [],
    next_recommended_steps: ["CAP-CONTACT-001", "CAP-VOP-001"],
    departments: ["Identity Acquisition"],
    workflows: [],
    keywords: ["ucie", "ingestion", "identity", "import", "ocr", "voter"],
    search_terms: ["import contacts", "identity acquisition", "ucie intake"],
    authority_level: "authoritative",
    completion_status: "production",
    maturity: {
      completion_percent: 94,
      health: "healthy",
      last_verified_slice: "CONTACT-V3-100",
      dependency_capability_ids: [],
    },
    slice_id: "CONTACT-V3-100",
    nav_placement: "department",
    nav_order: 5,
  }),
  cap({
    capability_id: "CAP-VOP-001",
    title: "Volunteer Operations (VOP)",
    description:
      "Volunteer profiles, claimable work marketplace, county/skill matching, supervisor dashboard",
    executive_question_ids: ["EQ-018"],
    primary_route: "/studio/volunteer",
    secondary_routes: [],
    prerequisites: ["CAP-CONTACT-001", "CAP-UCIE-100"],
    next_recommended_steps: [],
    departments: ["Volunteer Operations"],
    workflows: [],
    keywords: ["volunteer", "work marketplace", "vop", "supervisor", "claim"],
    search_terms: ["volunteer workspace", "claim work", "volunteer operations"],
    authority_level: "authoritative",
    completion_status: "partial",
    maturity: {
      completion_percent: 55,
      health: "healthy",
      last_verified_slice: "VOP-001",
      dependency_capability_ids: ["CAP-CONTACT-001", "CAP-UCIE-100"],
    },
    slice_id: "VOP-001",
    nav_placement: "department",
    nav_order: 6,
  ...
  cap({
    ...
    description: "Engagement heuristics and network intelligence",
    executive_question_ids: ["EQ-006"],
    primary_route: "/studio/relationships",
    secondary_routes: [],
    prerequisites: ["CAP-CONTACT-001"],
    next_recommended_steps: [],
    departments: ["Relationships"],
    workflows: [],
    keywords: ["relationships", "network", "engagement"],
    ...
    maturity: {
      ...
      dependency_capability_ids: ["CAP-CONTACT-001"],
    },
    slice_id: "LB-OS-015",
    nav_placement: "department",
    nav_order: 5,
