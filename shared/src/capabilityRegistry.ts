...
const FUTURE_EXECUTIVE_CAPABILITIES: CapabilityEntry[] = [
  ...
  futureCap({
    ...
    description:
      "LocalBrain-to-LocalBrain spoke · shared workspace · relationship sync · CoS-to-CoS update packets · approval before sharing — between distinct identities, not duplicate primaries for one person",
    executive_outcome:
    ...
    secondary_routes: [],
    prerequisites: ["CAP-PROD-003", "CAP-FUT-PRV-001", "CAP-FUT-ENC-001", "CAP-FUT-IDT-001"],
  ...
  futureCap({
    ...
    next_recommended_steps: ["CAP-FUT-MOB-001", "CAP-FUT-ING-001"],
    departments: ["Kernel", "Chief of Staff"],
    workflows: [],
    keywords: [
      "instance identity",
