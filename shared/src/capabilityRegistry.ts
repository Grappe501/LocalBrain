...
const FUTURE_EXECUTIVE_CAPABILITIES: CapabilityEntry[] = [
  ...
  futureCap({
    ...
    description:
      "LocalBrain-to-LocalBrain spoke · shared workspace · relationship sync · CoS-to-CoS update packets · approval before sharing",
    executive_outcome:
      "Kelly, Chris, and organization instances share governed packets — never whole-world context — with explicit approval.",
    executive_question_ids: [],
    primary_route: "/future/multi-brain-sharing",
    secondary_routes: [],
    prerequisites: ["CAP-PROD-003", "CAP-FUT-PRV-001", "CAP-FUT-ENC-001"],
    next_recommended_steps: ["CAP-FUT-UDI-001"],
    departments: ["Chief of Staff"],
    workflows: [],
    keywords: ["multi-brain", "spoke", "workspace sharing", "cos packets"],
    search_terms: ["multi brain sharing", "localbrain to localbrain", "cos update packet"],
    authority_level: "supporting",
  ...
  futureCap({
    ...
    description:
      "Signed license records · expired = view/export only · AI, outbound comms, sync, and new ingestion disabled · no data deletion · lifetime entitlements as signed records not plain text",
    executive_outcome:
    ...
    secondary_routes: [],
    prerequisites: ["CAP-PROD-003", "CAP-FUT-ENC-001"],
  ...
  futureCap({
    ...
    secondary_routes: [],
    prerequisites: ["CAP-PROD-001", "CAP-PROD-002", "CAP-FUT-LIC-001", "CAP-FUT-ENC-001", "CAP-FUT-PRV-001"],
    next_recommended_steps: ["CAP-FUT-UDI-001"],
    departments: ["Chief of Staff", "Knowledge Explorer"],
    workflows: [],
    keywords: [
  ...
  futureCap({
    ...
    secondary_routes: [],
    prerequisites: ["CAP-PROD-001", "CAP-FUT-LIC-001", "CAP-FUT-ENC-001"],
    next_recommended_steps: ["CAP-FUT-ING-001"],
