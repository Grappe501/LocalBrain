...
export const SURFACE_REGISTRY: LiveSurfaceEntry[] = [
  ...
  },
  {
    ...
    maturity_level: 2,
    target_maturity_level: 4,
    next_upgrade_slice: "LB-OS-020",
    next_upgrade_summary: "Executive Consolidation Briefing linked from planner arc",
  },
  {
    ...
    maturity_level: 3,
    target_maturity_level: 5,
    next_upgrade_slice: "LB-OS-020.5",
    next_upgrade_summary: "EIC cross-links across departments and Executive Briefing composer",
  },
];
