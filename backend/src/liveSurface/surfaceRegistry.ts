...
export const SURFACE_REGISTRY: LiveSurfaceEntry[] = [
  ...
  },
  {
    ...
    next_upgrade_summary: "H: filing taxonomy builder linked from planner arc",
  },
  {
    ...
    target_maturity_level: 4,
    next_upgrade_slice: "LB-OS-021",
    next_upgrade_summary: "Audit feeds filing taxonomy builder (L3)",
  },
  {
    ...
    target_maturity_level: 5,
    next_upgrade_slice: "LB-OS-021",
    next_upgrade_summary: "Consolidation insights feed filing and cutover planning",
  },
];
