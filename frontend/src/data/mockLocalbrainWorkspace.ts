...
export const MOCK_WORKSPACE_SIGNALS = [
  ...
  { label: "ENG-PMO-014", value: "COMPLETE · Contact Management V1 subsystem earned", tone: "positive" as const },
  { label: "Active gate", value: "Commercial Beta preparation", tone: "neutral" as const },
  { label: "V1 launch score", value: "~98% · live from Program Office API", tone: "positive" as const },
  { label: "Communications Office", value: "100% · ENG-PMO-013 COMPLETE · V1 subsystem", tone: "positive" as const },
  { label: "Contact Management", value: "100% · ENG-PMO-014 COMPLETE · V1 subsystem · 23/23 tests", tone: "positive" as const },
] as const;
